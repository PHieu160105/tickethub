...
export function PerformerCard({ performer }: { performer: ShowPerformer }) {
  return (
    <div className="relative group w-[210px] shrink-0 snap-start mx-2">
      ...
      <div className="absolute -inset-1 bg-gradient-to-r from-primary to-secondary rounded-xl blur opacity-55 group-hover:opacity-40 transition duration-1000" />
      
      <article className="relative overflow-hidden rounded-xl border-2 border-secondary bg-[var(--customer-bg-page)] shadow-lg hover:translate-y-[-4px] transition-all duration-300">
